...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int backgroundColorOfEachRow = ColorUtils.getViewHolderBackgroundColorFromInstance(context,viewHolderCount);
        // COMPLETED (13) Use ColorUtils.getViewHolderBackgroundColorFromInstance and pass in a Context and the viewHolderCount

        viewHolder.itemView.setBackgroundColor(backgroundColorOfEachRow);
        // COMPLETED (14) Set the background color of viewHolder.itemView with the color from above

        viewHolderCount++;
        Log.d("GreenAdapter","viewHolderCount : " + viewHolderCount);
